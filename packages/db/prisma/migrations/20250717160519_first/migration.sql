...
-- AddForeignKey
ALTER TABLE "WebsiteTick" ADD CONSTRAINT "WebsiteTick_parentTickId_fkey" FOREIGN KEY ("parentTickId") REFERENCES "WebsiteTick"("id") ON DELETE SET NULL ON UPDATE CASCADE;
